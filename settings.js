...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=jQsDSLSC#I9U8r0h_IWVBrBs005kZtNTSy8CFpnfgVrnZyyL71cI' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94775297095' : process.env.OWNER_NUMBER,   
